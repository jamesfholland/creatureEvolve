...
public class MainSim extends SimpleApplication implements ActionListener
{
  ...
  //Temporary vectors used on each frame. They here to avoid instanciating
  // new vectors on each frame
...
//        myCreature.getFitness());
  ...
  public static void main(String[] args)
  {
    ...
    settings
        .setSamples(4); //activate antialising (softer edges, may be slower.)

    //Set vertical syncing to true to time the frame buffer to coincide with
    // the refresh frequency of the screen.
    //This also throttles the calls to simpleUpdate. Without this throttling,
    // I get 1000+ pfs on my Alienware laptop
    //   Your application will have more work to do than to spend cycles
    // rendering faster than the
