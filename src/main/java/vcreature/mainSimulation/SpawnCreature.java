...
public class SpawnCreature extends Creature
{
  public SpawnCreature(PhysicsSpace physicsSpace, Node jMonkeyRootNode, String creatureName)
  {
    ...
    if (creatureName.equals("TableMonster2Legs"))
    {
      makeTableMonster();
    }
    else if (creatureName.equals("TableMonster4Legs"))
    {
      makeFourLeggedTableMonster();
    }
    else if (creatureName.equals("TableMonster4LegsFlat"))
    {
      makeFourLeggedTableMonsterFlat();
    }
    else if (creatureName.equals("Squid"))
    {
      makeSquid();
    }
    else if (creatureName.equals("FlappyBird"))
    {
      makeFlappyBird();
    }
  }
  ...
  {
    Vector3f torsoCenter = new Vector3f(0.0f, .5f, 0.0f);
    Vector3f torsoSize = new Vector3f(5.0f, .5f, 5f);
    Vector3f leg1Center = new Vector3f(-7.5f, .5f, 0f);
    Vector3f leg1Size = new Vector3f(2.250f, 0.5f, 0.5f);
    Vector3f leg2Center = new Vector3f(7.5f, .5f, 0f);
    Vector3f leg2Size = new Vector3f(2.250f, 0.5f, .5f);
    Vector3f leg3Center = new Vector3f(-0f, .5f, -7.50f);
    Vector3f leg3Size = new Vector3f(.50f, 0.5f, 2.250f);
    Vector3f leg4Center = new Vector3f(0f, .5f, 7.50f);
    Vector3f leg4Size = new Vector3f(.50f, 0.5f, 2.250f);
  ...
  {
    Vector3f torsoCenter = new Vector3f(0.0f, 1.5f, 0.0f);
    Vector3f torsoSize = new Vector3f(5.0f, .5f, 5f);
    Vector3f leg1Center = new Vector3f(-2.5f, .5f, -.50f);
    Vector3f leg1Size = new Vector3f(2.250f, 0.5f, 0.5f);
    Vector3f leg2Center = new Vector3f(2.5f, .5f, .50f);
    Vector3f leg2Size = new Vector3f(2.250f, 0.5f, .5f);
    Vector3f leg3Center = new Vector3f(-.50f, .5f, -2.50f);
    Vector3f leg3Size = new Vector3f(.50f, 0.5f, 2.250f);
    Vector3f leg4Center = new Vector3f(0.5f, .5f, 2.50f);
    Vector3f leg4Size = new Vector3f(.50f, 0.5f, 2.250f);
    Block torso = addRoot(torsoCenter, torsoSize);
  ...
  private void makeTableMonster()
  {
    ...
    Vector3f torsoCenter = new Vector3f(0.0f, 1.5f, 0.0f);
    Vector3f torsoSize = new Vector3f(5.0f, .5f, 5f);
    Vector3f leg1Center = new Vector3f(-0f, .5f, .50f);
    Vector3f leg1Size = new Vector3f(3.0f, 0.5f, 0.5f);
    Vector3f leg2Center = new Vector3f(0f, .5f, -.50f);
  ...
  {
    Vector3f torsoCenter = new Vector3f(0.0f, 1.5f, 0.0f);
    Vector3f torsoSize = new Vector3f(1.5f, .5f, 1.5f);
    Vector3f leg1Center = new Vector3f(5.0f, 0.5f, 0.0f);
    Vector3f leg1Size = new Vector3f(3.5f, 0.5f, 1.5f);
    Vector3f leg2Center = new Vector3f(-5.0f, 0.5f, 0.0f);
    Vector3f leg2Size = new Vector3f(3.5f, 0.5f, 1.5f);
